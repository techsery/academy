...
(function () {
  ...
  inject('site-nav', [
    ...
    '      <img class="brand-icon" src="images/techsery-icon.png" alt="" />',
  ...
  inject('site-footer', [
    ...
    '        <h5>Courses</h5>',
    '        <ul>',
    '          <li><a href="index.html?filter=all#courses">All</a></li>',
    '          <li><a href="index.html?filter=basics#courses">Basics</a></li>',
    '          <li><a href="index.html?filter=advanced#courses">Advanced</a></li>',
    '          <li><a href="index.html?filter=expert#courses">Expert</a></li>',
    '        </ul>',
    '      </div>',
    '',
    '      <div class="footer-col">',
